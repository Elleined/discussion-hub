...
public class ReplyNotification extends NotificationResponse {
    ...
    public ReplyNotification(int id, String message, String respondentPicture, int respondentId, ModalTracker.Type type, String notificationStatus, int count, String formattedDate, String formattedTime, int postId) {
